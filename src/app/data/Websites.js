...
export const websiteCategories = [
  ...
  },
  {
    ...
    cards: [
      ...
      { name: 'Panda Extract', href: 'https://pandaextract.com/', description: 'The Ultimate Web Scraper for any website Get all the data you need in one click.', icon: 'pandaextract.png' },
    ],
    icon: <CodeIcon />
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      { name: 'Free Minecraft Host', href: 'https://freeminecrafthost.com/ ', description: 'Unleash your Minecraft world with 8GB RAM, 200% CPU, and 10GB Storage. Instant setup, powerful features, and 24/7 uptime.', icon:'mchost.png' },
    ],
